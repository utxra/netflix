...
class getMessenger_Bus_Default_Middleware_HandleMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 1), 'Symfony\\Component\\Webhook\\Messenger\\SendWebhookMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.awhOMiC'] ?? $container->load('get_Messenger_HandlerDescriptor_AwhOMiCService'));
        }, 1), 'Symfony\\Component\\RemoteEvent\\Messenger\\ConsumeRemoteEventMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.rs4GYAy'] ?? $container->load('get_Messenger_HandlerDescriptor_Rs4GYAyService'));
        }, 1)]), false);
